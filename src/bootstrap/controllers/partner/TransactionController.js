...
var TransactionController = (function () {
    ...
    TransactionController.prototype.getHistoryTransaction = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var phone_number, logsTransaction;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        logsTransaction = _a.sent();
                        return [2, res.json({
                                success: true,
                                data: logsTransaction
                            })];
                }
            });
        });
    };
    TransactionController.prototype.checkStatusTransaction = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, phone_number, transaction_id, logsTransaction;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = req.body, phone_number = _a.phone_number, transaction_id = _a.transaction_id;
                        return [4, typeorm_1.getConnection()
                                .createQueryBuilder()
                                .select("logs_transaction")
                                .from(LogsTransactionModel_1["default"], "logs_transaction")
                    ...
                    case 2:
                        logsTransaction = _b.sent();
                        return [2, res.json({
                                success: true,
                                transaction_id: transaction_id,
                                status: logsTransaction.status
                            })];
                }
            });
        });
